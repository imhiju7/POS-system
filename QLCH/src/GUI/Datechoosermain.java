 ...
 * @author raven
 */
public class Datechoosermain extends javax.swing.JFrame {

    /**
     * Creates new form Main
     */
    public Datechoosermain() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Datechoosermain.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Datechoosermain().setVisible(true);
            }
        });
    }
