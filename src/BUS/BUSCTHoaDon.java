...
public class BUSCTHoaDon {
    ...
    public void jtimport(JTable jt, ArrayList<DTOCTHoaDon> list) throws SQLException {
        ...
        for (DTOCTHoaDon i : list) {
            ...
            sp = DAOsp.getsp(sp);
            model.addRow(new Object[]{i.getMaCTHoaDon(), sp.getTenSanPham(), i.getDonGia(), i.getSoLuong(), i.getMaHoaDon(), i.getGhiChu()});
        }
        jt.setModel(model);
    }
    ...
    public ArrayList<DTOCTHoaDon> searchghichu(ArrayList<DTOCTHoaDon> list, String ghichu) {
        ArrayList<DTOCTHoaDon> result = new ArrayList<>();
        for (DTOCTHoaDon i : list) {
