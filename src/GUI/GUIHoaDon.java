...
public class GUIHoaDon extends javax.swing.JPanel {
    ...
    public void resetall(){
        ...
        try {
            ...
            Logger.getLogger(GUIHoaDon.class.getName()).log(Level.SEVERE, null, ex);
    ...
    private void initComponents() {
        ...
        jButton8.setText("Điểm tích lũy");
        ...
        jComboBox2.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Loại tìm kiếm", "Tên nhân viên", "SDT khách hàng", "Ghi chú" }));
        ...
        jComboBox3.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Loại", "Ngày tạo", "Tổng tiền" }));
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        ...
        if(!jTextField8.getText().toString().isEmpty()){
            ...
            new GUICTHoaDon(mapn).setVisible(true);
        }
        else{
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        ...
        if(!item.isEmpty()){
            try {
                ...
                if(select == 1){
                    hoadon.jtimport(jTable1, hoadon.searchten(list, item));
                }
                else if(select == 2){
                    hoadon.jtimport(jTable1, hoadon.searchsdt(list, item));
                }
                else if(select == 3){
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        jTextField11.setText(jTable1.getValueAt(index, 6).toString());
        jTextField12.setText(jTable1.getValueAt(index, 4).toString());
        ...
        jTextField4.setText(jTable1.getValueAt(index, 5).toString());
        if(jTable1.getValueAt(index, 7)!=null){
            jTextField5.setText(jTable1.getValueAt(index, 7).toString());
        }
        else{
            jTextField5.setText("");
        }
